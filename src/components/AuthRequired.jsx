    ...
    <div className={`${colors.bg} text-slate-100 min-h-screen flex items-center justify-center p-4`}>
      <div className="relative z-10 max-w-6xl w-full">
        ...
        <div className="max-w-md mx-auto bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 shadow-2xl border border-slate-700/50">
          ...
          <button
            onClick={onSignIn}
            className="w-full bg-white hover:bg-gray-50 text-gray-900 font-medium py-3 px-4 rounded-xl transition-all duration-200 flex items-center justify-center gap-3 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 mb-4"
          >
          ...
          <button
            onClick={onGoBack}
            className="w-full bg-slate-700/50 hover:bg-slate-600/50 text-slate-200 font-medium py-3 px-4 rounded-xl transition-all duration-200 flex items-center justify-center gap-3 border border-slate-600/50 hover:border-slate-500/50"
          >
